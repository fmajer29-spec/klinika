<img width="1024" height="1024" alt="111 jpg" src="https://github.com/user-attachments/assets/b8d85d99-c174-40f0-9b69-a68a1320e07b" />
<img width="1024" height="1024" alt="222 jpg" src="https://github.com/user-attachments/assets/14560d2d-b564-4ee4-9e71-1204a4f26ebb" />
[index (1).html](https://github.com/user-attachments/files/23914841/index.1.html)
<!DOCTYPE html>
<html lang="pl">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <li><a href="https://www.znanylekarz.pl/" target="_blank" rel="noopener noreferrer" class="nav-cta">Umów wizytę</a></li>
        </ul>
    </nav>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <a href="https://www.znanylekarz.pl/" target="_blank" rel="noopener noreferrer" class="hero-cta">Umów bezpłatną konsultację</a>
        </div>
        <div class="hero-image" style="background-image: url('C:/Users/Predator/Desktop/folder/111.jpg');"></div>
    </section>
    ...
    <section class="about" id="omnie">
        <div class="about-image" style="background-image: url('N2J6yo1QhcOSYeqZObltn');"></div>
    ...
    <section class="cta" id="kontakt">
        ...
        <a href="https://www.znanylekarz.pl/" target="_blank" rel="noopener noreferrer" class="cta-button">Zarezerwuj wizytę</a>
    </section>
